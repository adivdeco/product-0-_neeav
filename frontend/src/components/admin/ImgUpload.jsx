...
const ImageUpload = ({ userId, onUploadSuccess, onAvatarUpdate }) => {
    ...
    return (
        <div className="flex gap-32">
            {/* File Input */}
            <div className="w-md relative border-2 border-dashed border-gray-300 rounded-2xl p-6 transition-all duration-300 hover:border-blue-400 hover:bg-blue-50 group">
