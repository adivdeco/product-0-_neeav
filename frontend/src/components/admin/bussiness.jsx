            ...
            <div className="py-10 px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        Register your shop or service to reach more customers and expand your business
                        through our trusted platform. Join thousands of successful businesses today.
                    </p>

                    {/* Authentication Status Badge */}
                    {isAuthenticated && (
                        <div className="inline-flex items-center px-4 py-1 rounded-full bg-emerald-50 border border-emerald-200 mt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 border border-gray-100 group cursor-pointer">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600 mb-6 leading-relaxed">
                                    Perfect for retail stores, businesses.
                                    Showcase your products and location to local customers.
                                </p>
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                >
                                    {loading ? 'Checking Access...' : 'Register Shop'}
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 border border-gray-100 group cursor-pointer">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600 mb-6 leading-relaxed">
                                    Ideal for professionals offering services.
                                    Connect with customers needing your expertise.
                                </p>
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                >
                                    {loading ? 'Checking Access...' : 'Register Service'}
                                </button>
                            </div>
                        </div>
                    </div>
